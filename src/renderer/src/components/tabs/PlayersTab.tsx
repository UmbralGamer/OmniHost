...
interface PlayersTabProps {
  ...
  playerListType: 'live' | 'whitelist' | 'ops' | 'banned-players' | 'banned-ips';
  setPlayerListType: React.Dispatch<React.SetStateAction<'live' | 'whitelist' | 'ops' | 'banned-players' | 'banned-ips'>>;
